  ...
  <v-container fluid>
    <v-row>
      ...
      >
        ...
        >
          <template #title>
            <div class="text-h4 mt-2 font-weight-light">
              Coloured Line Chart
              <span class="text-subtitle-1">— Rounded</span>
            </div>
          </template>
        ...
        >
          <template #title>
            <div class="text-h4 font-weight-light mt-2">
              Coloured Line Chart
              <span class="text-subtitle-1">— Multiple</span>
            </div>
          </template>
      ...
      >
        ...
        >
          <template #title>
            <div class="text-h4 mt-2 font-weight-light">
              Multiple Bars Chart
              <span class="text-subtitle-1">— Bar Chart</span>
            </div>
          </template>
